...
namespace QueryDB.MSSQL
{
    ...
    internal sealed class Adapter
    {
        ...
        internal SqlDataReader GetSqlReader(string cmdText, SqlConnection connection, CommandType commandType, object parameters = null)
        {
            connection.Open();
            using (var sqlCommand = new SqlCommand(cmdText, connection) { CommandType = commandType })
            {
                if (parameters != null)
                {
                    foreach (var param in Utils.ToSqlParameters(parameters))
        ...
        internal SqlCommand GetSqlCommand(string cmdText, SqlConnection connection, CommandType commandType, object parameters = null)
        {
            connection.Open();
        ...
        internal static SqlCommand GetSqlCommand(string cmdText, SqlConnection connection, SqlTransaction transaction, object parameters = null)
        {
        ...
        internal List<DataDictionary> FetchData(string selectSql, SqlConnection connection, bool upperCaseKeys, object parameters = null)
        {
            var dataList = new List<DataDictionary>();
            using (var reader = GetSqlReader(selectSql, connection, CommandType.Text, parameters))
            {
                while (reader.Read())
                {
        ...
        internal List<T> FetchData<T>(string selectSql, SqlConnection connection, bool strict, object parameters = null) where T : new()
        {
        ...
        /// </returns>
        internal string ExecuteScalar(string sqlStatement, SqlConnection connection, object parameters = null)
        {
            using (var sqlCommand = GetSqlCommand(sqlStatement, connection, CommandType.Text, parameters))
            {
        ...
        /// </returns>
        internal T ExecuteScalar<T>(string sqlStatement, SqlConnection connection, object parameters = null)
        {
            using (var sqlCommand = GetSqlCommand(sqlStatement, connection, CommandType.Text, parameters))
            {
                var result = sqlCommand.ExecuteScalar();
        ...
        internal int ExecuteCommand(string sqlStatement, SqlConnection connection, object parameters = null)
        {
            using(var sqlCommand = GetSqlCommand(sqlStatement, connection, CommandType.Text, parameters))
            {
        ...
        /// </returns>
        internal static Result ExecuteTransaction(List<string> sqlStatements, SqlConnection connection, object parameters = null)
        {
            using (SqlTransaction transaction = GetSqlTransaction(connection))
            {
                try
                {
                    ...
                    {
                        using (var sqlCommand = GetSqlCommand(sqlStatement, connection, transaction, parameters))
                        {
        ...
        /// <param name="parameters">Query parameters for parameterized SQL execution. Default - <c>null</c>.</param>
        /// <returns>A <see cref="SqlDataReader"/> object that can be used to read the query results.</returns>
        internal async Task<SqlDataReader> GetSqlReaderAsync(string cmdText, SqlConnection connection, CommandType commandType, object parameters = null)
        {
        ...
        /// <param name="parameters">Query parameters for parameterized SQL execution. Default - <c>null</c>.</param>
        /// <returns>A configured <see cref="SqlCommand"/> instance.</returns>
        internal async Task<SqlCommand> GetSqlCommandAsync(string cmdText, SqlConnection connection, CommandType commandType, object parameters = null)
        {
            await connection.OpenAsync();
            var sqlCommand = new SqlCommand(cmdText, connection) { CommandType = commandType };
            if (parameters != null)
        ...
        /// <returns>List of <see cref="DataDictionary"/> with column names as keys holding values into a list for multiple rows of data.
        /// Note: Byte[] is returned as Base64 string.</returns>
        internal async Task<List<DataDictionary>> FetchDataAsync(string selectSql, SqlConnection connection, bool upperCaseKeys, object parameters = null)
        {
            var dataList = new List<DataDictionary>();
            using (var reader = await GetSqlReaderAsync(selectSql, connection, CommandType.Text, parameters))
            {
        ...
        /// <param name="parameters">Query parameters for parameterized SQL execution. Default - <c>null</c>.</param>
        /// <returns>List of data rows mapped into object of type <typeparamref name="T"/>.</returns>
        internal async Task<List<T>> FetchDataAsync<T>(string selectSql, SqlConnection connection, bool strict, object parameters = null) where T : new()
        {
            var dataList = new List<T>();
            using (var reader = await GetSqlReaderAsync(selectSql, connection, CommandType.Text, parameters))
            {
        ...
        /// or an empty string if the result is DBNull.
        /// </returns>
        internal async Task<string> ExecuteScalarAsync(string sqlStatement, SqlConnection connection, object parameters = null)
        {
            using (var sqlCommand = await GetSqlCommandAsync(sqlStatement, connection, CommandType.Text, parameters))
            {
        ...
        /// or the default value of <typeparamref name="T"/> if the result is DBNull.
        /// </returns>
        internal async Task<T> ExecuteScalarAsync<T>(string sqlStatement, SqlConnection connection, object parameters = null)
        {
            using (var sqlCommand = await GetSqlCommandAsync(sqlStatement, connection, CommandType.Text, parameters))
            {
                var result = await sqlCommand.ExecuteScalarAsync();
        ...
        /// <param name="parameters">Query parameters for parameterized SQL execution. Default - <c>null</c>.</param>
        /// <returns>The number of rows affected by the execution of the SQL statement.</returns>
        internal async Task<int> ExecuteCommandAsync(string sqlStatement, SqlConnection connection, object parameters = null)
        {
            using (var sqlCommand = await GetSqlCommandAsync(sqlStatement, connection, CommandType.Text, parameters))
            {
        ...
        /// If an error occurs, the <see cref="Result.Exception"/> property contains the exception details.
        /// </returns>
        internal static async Task<Result> ExecuteTransactionAsync(List<string> sqlStatements, SqlConnection connection, object parameters = null)
        {
