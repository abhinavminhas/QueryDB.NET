...
namespace QueryDB
{
    ...
    interface IDBContext
    {
        ...
        List<DataDictionary> FetchData(string selectSql, bool upperCaseKeys = false, object parameters = null);
        ...
        List<T> FetchData<T>(string selectSql, bool strict = false, object parameters = null) where T : new();
        ...
        /// <param name="parameters">Query parameters for parameterized SQL execution. Default - <c>null</c>.</param>
        /// <returns>List of <see cref="DataDictionary"/> with column names as keys holding values into a list for multiple rows of data.</returns>
        Task<List<DataDictionary>> FetchDataAsync(string selectSql, bool upperCaseKeys = false, object parameters = null);
        ...
        /// <param name="parameters">Query parameters for parameterized SQL execution. Default - <c>null</c>.</param>
        /// <returns>List of data rows mapped into object of type <typeparamref name="T"/>.</returns>
        Task<List<T>> FetchDataAsync<T>(string selectSql, bool strict = false, object parameters = null) where T : new();
        ...
        /// </returns>
        string ExecuteScalar(string sqlStatement, object parameters = null);
        ...
        /// </returns>
        T ExecuteScalar<T>(string sqlStatement, object parameters = null);
        ...
        /// or an empty string if the result is DBNull.
        /// </returns>
        Task<string> ExecuteScalarAsync(string sqlStatement, object parameters = null);
        ...
        /// or the default value of <typeparamref name="T"/> if the result is DBNull.
        /// </returns>
        Task<T> ExecuteScalarAsync<T>(string sqlStatement, object parameters = null);
        ...
        int ExecuteCommand(string sqlStatement, object parameters = null);
        ...
        /// <param name="parameters">Query parameters for parameterized SQL execution. Default - <c>null</c>.</param>
        /// <returns>The number of rows affected by the execution of the SQL statement.</returns>
        Task<int> ExecuteCommandAsync(string sqlStatement, object parameters = null);
        ...
        /// </returns>
        Result ExecuteTransaction(List<string> sqlStatements, object parameters = null);
        ...
        /// If an error occurs, the <see cref="Result.Exception"/> property contains the exception details.
        /// </returns>
        Task<Result> ExecuteTransactionAsync(List<string> sqlStatements, object parameters = null);
    }
}
